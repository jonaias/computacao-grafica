...
ponte_do_mal: main.o object.o createscene.o cylinder.o plane.o
	$(CC) -o ./bin/ponte_do_mal ./build/object.o ./build/createscene.o ./build/cylinder.o ./build/plane.o ./build/main.o 
main.o: main.cpp
